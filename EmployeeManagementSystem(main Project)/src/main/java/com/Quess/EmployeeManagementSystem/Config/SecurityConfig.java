...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.sessionManagement().sessionCreationPolicy(SessionCreationPolicy.STATELESS).and()
                ...
                .antMatchers(HttpMethod.PUT,"/employee/{id}").hasAnyAuthority("ADMIN")
                .antMatchers(HttpMethod.DELETE,"/employee/{id}").hasAnyAuthority("ADMIN")

                .antMatchers(HttpMethod.GET,"/organization").hasAnyAuthority("ADMIN","MANAGER","EMPLOYEE")
                ...
                .antMatchers(HttpMethod.POST,"/assets").hasAnyAuthority("ADMIN")
                .antMatchers(HttpMethod.PUT,"/assets").hasAnyAuthority("ADMIN")
